...
- Demarrer  votre VM puis sur Tiny core recuperer l'adresse ip avec la commande :
 ...
 ## Creation du Chargeur DSM 7.1
  ...
  - le fichier **loader.img** est le fichier Contenant la compilation finale de la version **7.1** du Model **DS3622xs+** avce le pilote **intel e1000**
  ...
  ## Action Finale Pour Sauvegarder Votre Session dans Tiny Core 
